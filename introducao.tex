...
%\begin{figure}[!htb]
%\centering
%\includegraphics[scale=1.1]{drawing2}
%\caption{{\it A abordagem proposta transforma um conjunto de imagens calibradas no desenho 3D na forma de um gráfico consistindo de segmentos de curvas 3D que se ligam nas junções.}}
%\label{fig.drawing}
%\end{figure}
