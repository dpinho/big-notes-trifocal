...
\subfloat{\includegraphics[width=0.45\hsize]{leao-mosul}}\hfill
\quad
\subfloat{\includegraphics[width=0.47\hsize]{lion-mosul-2}}\hfill
...
\subfloat{\includegraphics[width=.713\hsize]{carro}}\hfill
\subfloat{\includegraphics[width=.28\hsize]{objeto-curvo}}\hfill
...
\subfloat{\includegraphics[width=.49\hsize]{medusa1}}\hfill
\subfloat{\includegraphics[width=.49\hsize]{medusa2}}\hfill
\\
\subfloat{\includegraphics[width=.49\hsize]{nuvem1}}\hfill
\subfloat{\includegraphics[width=.49\hsize]{nuvem2}}\hfill
\\
\subfloat{\includegraphics[width=.49\hsize]{texturizacao2}}\hfill
\subfloat{\includegraphics[width=.49\hsize]{texturizacao-realmente}}\hfill
